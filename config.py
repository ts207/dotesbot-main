...
EVENT_VALUE_TRADE_USD = float(os.getenv("EVENT_VALUE_TRADE_USD", "50.0"))
...
DSWING_MAX_PER_MATCH = float(os.getenv("DSWING_MAX_PER_MATCH", str(VALUE_MAX_PER_MATCH)))
EVENT_MAX_PER_MATCH = float(os.getenv("EVENT_MAX_PER_MATCH", str(VALUE_MAX_PER_MATCH)))
...
MODEL_VALUE_EDGE_MODE = os.getenv("MODEL_VALUE_EDGE_MODE", "residual")

if MODEL_VALUE_EDGE_MODE == "residual":
    DEFAULT_MODEL_VALUE_MIN_EDGE = "0.02"
else:
    DEFAULT_MODEL_VALUE_MIN_EDGE = "0.15"

MODEL_VALUE_MIN_EDGE = float(os.getenv(
...
MODEL_VALUE_CONFIRM_MIN_EDGE = float(os.getenv(
    "MODEL_VALUE_CONFIRM_MIN_EDGE",
    str(MODEL_VALUE_MIN_EDGE),
))
MODEL_VALUE_CONFIRM_MIN_AGE_SEC = float(os.getenv("MODEL_VALUE_CONFIRM_MIN_AGE_SEC", "1.0"))
MODEL_VALUE_CONFIRM_MAX_AGE_SEC = float(os.getenv("MODEL_VALUE_CONFIRM_MAX_AGE_SEC", "90"))
MODEL_VALUE_CONFIRM_MAX_ASK_WORSEN = float(os.getenv("MODEL_VALUE_CONFIRM_MAX_ASK_WORSEN", "0.02"))
MODEL_VALUE_MIN_ASK = float(os.getenv("MODEL_VALUE_MIN_ASK", "0.05"))
MODEL_VALUE_MAX_ASK = float(os.getenv("MODEL_VALUE_MAX_ASK", "0.95"))
...
MODEL_VALUE_MIN_GAME_TIME_SEC = int(os.getenv("MODEL_VALUE_MIN_GAME_TIME_SEC", "420"))
MODEL_VALUE_MAX_GAME_TIME_SEC = int(os.getenv("MODEL_VALUE_MAX_GAME_TIME_SEC", "2400"))
