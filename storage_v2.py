        ...
        with self.connect() as conn:
            conn.execute(
                ...
                (
                    ...
                    str(pos_dict.get("token_id", "")),
                    str(pos_dict.get("match_id", "")),
                    float(pos_dict.get("entry_price") if pos_dict.get("entry_price") is not None else 0.0),
                    float(pos_dict.get("exit_price") if pos_dict.get("exit_price") is not None else 0.0),
                    float(pos_dict.get("shares") if pos_dict.get("shares") is not None else 0.0),
                    float(pos_dict.get("cost_usd") if pos_dict.get("cost_usd") is not None else 0.0),
                    float(pos_dict.get("pnl_usd") if pos_dict.get("pnl_usd") is not None else 0.0),
                    str(pos_dict.get("side", "")),
                    mode,
