...
# ---------- trade_attempts ----------
# Union of live and paper attempt ledgers. `trader_kind` distinguishes the
# writer; `signal_id` joins back to signals where available.
...
# ---------- value_attempts ----------
# Source: value_attempts.csv. One row per value-engine signal or reject.
